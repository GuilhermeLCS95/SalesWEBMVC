...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r3 = new SalesRecord(new int(), new DateTime(2018, 09, 13), 4000.0, SaleStatus.Cancelled, s4);
            ...
            SalesRecord r23 = new SalesRecord(new int(), new DateTime(2018, 10, 19), 11000.0, SaleStatus.Cancelled, s2);
